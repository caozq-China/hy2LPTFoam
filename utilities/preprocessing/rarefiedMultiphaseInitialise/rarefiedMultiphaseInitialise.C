...
int main(int argc, char *argv[])
{
    ...
    Info<< "Initialising solid for Time = " << runTime.timeName() << nl << endl;

    solidParticleCouplingCloud spc(runTime, "spc", mesh, solidInitialiseDict,&dsmc, true);

//     solidParticleCouplingCloud spc(mesh, "spc", dsmc)
...
//         << nl << endl;
    ...
    if (!mesh.write())
    {
        FatalErrorIn(args.executable())
            << "Failed writing solidParticleCouplingCloud."
            << nl << exit(FatalError);
    }
