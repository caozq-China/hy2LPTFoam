...
template<class Type>
Foam::labelList Foam::mppicAveragingMethods::DualMethod<Type>::sizing
(
    const fvMesh& mesh
)
{
...
template<class Type>
Foam::mppicAveragingMethods::DualMethod<Type>::DualMethod
(
    const IOobject& io,
...
:
    mppicAveragingMethod<Type>(io, dict, mesh, sizing(mesh)),
    volumeCell_(mesh.V()),
...
Foam::mppicAveragingMethods::DualMethod<Type>::DualMethod
(
    const DualMethod<Type>& am
)
:
    mppicAveragingMethod<Type>(am),
...
template<class Type>
void Foam::mppicAveragingMethods::DualMethod<Type>::syncDualData()
{
...
template<class Type>
void Foam::mppicAveragingMethods::DualMethod<Type>::add
(
...
template<class Type>
Type Foam::mppicAveragingMethods::DualMethod<Type>::interpolate
(
    const barycentric& coordinates,
    const tetIndices& tetIs
) const
...
template<class Type>
typename Foam::mppicAveragingMethods::DualMethod<Type>::TypeGrad
Foam::mppicAveragingMethods::DualMethod<Type>::interpolateGrad
(
    const barycentric& coordinates,
    const tetIndices& tetIs
) const
...
template<class Type>
void Foam::mppicAveragingMethods::DualMethod<Type>::average()
{
    syncDualData();

    mppicAveragingMethod<Type>::average();
}
...
)
{
    ...
    mppicAveragingMethod<Type>::average(weight);
}


template<class Type>
Foam::tmp<Foam::Field<Type> >
Foam::mppicAveragingMethods::DualMethod<Type>::primitiveField() const
{
