...
Foam::nonEquilibrium::nonEquilibrium
(
...
) const
{
    static const scalar a =
       ...
       *0.25*(1.0 - e_*e_);
    //- this is the expression of equation (45) in
    //- "An inproved collision damping time for MPPIC calculations
    //- of dense  particle flows with applications to polydisperse 
    //- sedimenting beds and colliding particle jets"
