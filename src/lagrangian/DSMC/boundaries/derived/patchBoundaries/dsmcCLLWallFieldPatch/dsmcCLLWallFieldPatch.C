...
Foam::dsmcCLLWallFieldPatch::dsmcCLLWallFieldPatch
(
    const polyMesh& mesh,
    dsmcCloud& cloud,
...
void Foam::dsmcCLLWallFieldPatch::initialConfiguration()
{
    if
    (
...
void Foam::dsmcCLLWallFieldPatch::calculateProperties()
{}


void Foam::dsmcCLLWallFieldPatch::controlParticle
(
    dsmcParcel& p,
...
void Foam::dsmcCLLWallFieldPatch::output
(
...
void Foam::dsmcCLLWallFieldPatch::updateProperties(const dictionary& dict)
{
...
void Foam::dsmcCLLWallFieldPatch::setProperties()
{}
