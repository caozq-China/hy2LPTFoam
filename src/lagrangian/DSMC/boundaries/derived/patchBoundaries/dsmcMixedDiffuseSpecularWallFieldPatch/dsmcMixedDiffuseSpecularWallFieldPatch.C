...
Foam::dsmcMixedDiffuseSpecularWallFieldPatch::
dsmcMixedDiffuseSpecularWallFieldPatch
(
    const polyMesh& mesh,
    dsmcCloud& cloud,
...
void Foam::dsmcMixedDiffuseSpecularWallFieldPatch::initialConfiguration()
{}


void Foam::dsmcMixedDiffuseSpecularWallFieldPatch::calculateProperties()
{}


void Foam::dsmcMixedDiffuseSpecularWallFieldPatch::controlParticle
(
    dsmcParcel& p,
...
void Foam::dsmcMixedDiffuseSpecularWallFieldPatch::output
(
...
void Foam::dsmcMixedDiffuseSpecularWallFieldPatch::updateProperties
(
    const dictionary& dict
)
{
