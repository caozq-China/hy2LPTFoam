    ...
    n_()
{
    ...
    avVolume_ = 4.0*radius_*radius_*radius_
                        *constant::mathematical::pi/(3.0*nBins_);
    ...
    scalar binWidth = Foam::pow((3.0*avVolume_
                        /(4.0*constant::mathematical::pi)), (1.0/3.0));
    ...
    for (label i = 1; i < nBins_; i++)
    {
        ...
        scalar r1 = pow(((3.0*avVolume_/(4.0*constant::mathematical::pi))
                                                    + (r2*r2*r2)), (1.0/3.0));
...
label sphericalBins::nBins() const
{
    return nBins_;
}
