...
Foam::label Foam::radialBinsNormalised::findBin(const scalar r)
{
    label n = -1;
...
Foam::radialBinsNormalised::radialBinsNormalised
(
    const polyMesh& mesh,
...
Foam::label Foam::radialBinsNormalised::isPointWithinBin
(
    const vector& rI,
    const label cellI
)
...
Foam::scalarField Foam::radialBinsNormalised::binPositions()
{
    return magRadii_;
}


Foam::vectorField Foam::radialBinsNormalised::bins()
{
...
Foam::label Foam::radialBinsNormalised::nBins() const
{
    return nBins_;
}


Foam::scalar Foam::radialBinsNormalised::binVolume(const label n)
{
