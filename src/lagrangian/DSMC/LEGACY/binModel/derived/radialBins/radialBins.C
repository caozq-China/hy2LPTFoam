...
Foam::label Foam::radialBins::findBin(const scalar r)
{
    label n = -1;
...
Foam::label Foam::radialBins::isPointWithinBin
(
    const vector& rI,
    const label cellI
)
...
Foam::scalarField Foam::radialBins::binPositions()
{
    return magRadii_;
}


Foam::vectorField Foam::radialBins::bins()
{
...
Foam::label Foam::radialBins::nBins() const
{
    return nBins_;
}


Foam::scalar Foam::radialBins::binVolume(const label n)
{
    return avVolume_;
}
