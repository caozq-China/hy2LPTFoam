...
// {
    ...
    addToRunTimeSelectionTable(ParticleStressModel, Lun, dictionary);
// }
}
...
Foam::tmp<Foam::Field<Foam::scalar>> Foam::Lun::tau
(
...
Foam::tmp<Foam::Field<Foam::scalar>> Foam::Lun::dTaudTheta
(
    const Field<scalar>& alpha,
    const Field<scalar>& rho,
    const Field<scalar>& uSqr
