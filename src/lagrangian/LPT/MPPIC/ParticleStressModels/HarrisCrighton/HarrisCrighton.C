...
// {
    ...
    addToRunTimeSelectionTable(ParticleStressModel, HarrisCrighton, dictionary);
// }
}
...
Foam::HarrisCrighton::HarrisCrighton
(
...
Foam::tmp<Foam::Field<Foam::scalar>> Foam::HarrisCrighton::denominator
(
...
Foam::tmp<Foam::Field<Foam::scalar>> Foam::HarrisCrighton::tau
(
    const Field<scalar>& alpha,
...
Foam::tmp<Foam::Field<Foam::scalar>> Foam::HarrisCrighton::dTaudTheta
(
    const Field<scalar>& alpha,
    const Field<scalar>& rho,
    const Field<scalar>& uSqr
