...
:
    ...
    smoothTheta_(dict.lookupOrDefault("smoothTheta",false)),
    smoothSourceTerms_(dict.lookupOrDefault("smoothSourceTerms",false)),
    useGasFilter_(dict.lookupOrDefault("useGasFilter",false)),
    useGasFilterImplicit_(dict.lookupOrDefault("useGasFilterImplicit",false)),
    // calcFrequency_(1),
    maxCo_(0.3),
    iter_(1),
    trackTime_(0.0),
