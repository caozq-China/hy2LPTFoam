...
#include "variableTimeStepModel.H"
...
namespace Foam
{
    defineTypeNameAndDebug(variableTimeStepModel, 0);
...
void variableTimeStepModel::findRefCell()
{
...
void variableTimeStepModel::updatenParticles()
{
    findRefCell();
...
void variableTimeStepModel::updateTimeStep()
{
...
void variableTimeStepModel::updateVariableTimeStepMethod()
{
    updatenParticles();
...
//- Constructor
variableTimeStepModel::variableTimeStepModel
(
    Time& t,
    const polyMesh& mesh,
...
void variableTimeStepModel::checkTimeStepModelInputs()
{
...
void variableTimeStepModel::update()
{
    updateVariableTimeStepMethod();
}


void variableTimeStepModel::writeTimeStepModelInfo() const
{
    Info<< "Variable time-step model:" << nl
        << "- Initial time-step [sec]" << tab
        << TimeStepModel::deltaTValue(0) << nl
        << endl;
}
